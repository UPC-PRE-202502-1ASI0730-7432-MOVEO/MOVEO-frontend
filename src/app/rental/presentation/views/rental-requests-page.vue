  ...
  try {
    ...
    try {
      ...
      const notification = {
        ...
        message: `Has recibido una calificación de ${starsEmoji} como inquilino.${commentPart}`,
  ...
  try {
    ...
    try {
      const notification = {
        ...
        message: `Tu solicitud de alquiler para ${request.vehicle?.brand} ${request.vehicle?.model} ha sido aceptada. ¡Prepárate para tu aventura!`,
